...
const FeatureCard = ({ icon, title, content, index}) => (
    <div className={`flex xs:flex-row flex-col xs:p-6 p-2 rounded-[20px] ${index !== features.length - 1 ?  "mb-6" : "mb-0"} feature-card`}>
      <div className={`xs:mb-0 mb-6 w-[64px] h-[64px] rounded-full ${styles.flexCenter} bg-[#d1d4db]`}>
